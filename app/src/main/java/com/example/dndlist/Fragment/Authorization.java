 ...
 * Use the {@link Authorization#newInstance} factory method to
...
public class Authorization extends Fragment {
    ...
    public static Authorization newInstance(String param1, String param2) {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState){
        ...
        view.findViewById(R.id.valid_btn).setOnClickListener(new View.OnClickListener() {
            @Override
